...
Route::get('/cadastroFuncionarios', [FuncionarioController::class, 'gerenciarFunci'])->name('gerenciar-funcionario');
...
Route::get('/cadastroQuarto', [QuartoController::class, 'gerenciarQuarto'])->name('gerenciar-quarto');
...
Route::get('/cadastroReserva', [ReservaController::class, 'gerenciarReserva'])->name('gerenciar-reserva');